...
type
  ...
  private
    // current hint color for buttons 
    FHintColor: TColor;
  public
...
procedure TToolbarForm.DoShowHint(var HintStr: string;
  var CanShow: Boolean; var HintInfo: THintInfo);
begin
  if HintInfo.HintControl.Parent = Panel1 then
...
begin
  ColorDialog1.Color := FHintColor;
  if ColorDialog1.Execute then
    FHintColor := ColorDialog1.Color;
end;
