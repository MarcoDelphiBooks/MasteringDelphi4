...
begin
  // create first object
  Num1 := CreateComObject (CLSID_NumServer) as INumber;
  ...
  Num2 := CreateComObject (CLSID_NumServer) as INumber;
...
begin
  ...
  Num3 := CreateComObject (CLSID_NumServer) as INumber;
  Num3.SetValue (100);
  Num3.Increase;
